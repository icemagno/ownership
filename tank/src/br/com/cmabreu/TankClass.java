...
public class TankClass {
	...
	*/
	...
	public void updateAttributeValuesObject( TankObject tank ) throws Exception {
		...
		HLAunicodeString tempAttributeValue = encoder.createHLAunicodeString( "This is a Temp value" );
		...
		attributes.put( tempAttributeHandle, tempAttributeValue.toByteArray() );	
